...
import input_data
import input_data_HX
#import input_data_cd
import VGG
import tools
...
IS_PRETRAIN = True
#data_dir = 'D:/DATA/huaxi/train1/'
#tra_images, tra_labels, val_images, val_labels = input_data_HX.get_files(data_dir, 0.2)
#tra_image_batch, tra_label_batch = input_data_HX.get_batch(tra_images, tra_labels, IMG_W, IMG_H, BATCH_SIZE, 1000)
#%%   Training
def train():
    
    pre_trained_weights = 'C:/MLproject/My-TensorFlow-tutorials-master/04 VGG Tensorflow/vgg16.npy'
    data_dir = 'D:/DATA/huaxi/train1/'
    train_log_dir = 'D:/DATA/huaxi/data/logs/train/'
    val_log_dir = 'D:/DATA/huaxi/data/logs/val/'
...
#                                                 shuffle=False)
        ...
        tra_image_batch, tra_label_batch = input_data_HX.get_batch(tra_images, tra_labels, IMG_W, IMG_H, BATCH_SIZE, N_CLASSES, 1000)
        
        val_image_batch, val_label_batch = input_data_HX.get_batch(val_images, val_labels, IMG_W, IMG_H, BATCH_SIZE, N_CLASSES, 1000)
